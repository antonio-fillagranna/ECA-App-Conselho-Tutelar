        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('eca.show')" :active="request()->routeIs('eca.show')">
                        {{ __('ECA') }}
                    </x-nav-link>
                    <x-nav-link :href="route('contact.show')" :active="request()->routeIs('contact.show')">
                        {{ __('Contato') }}
                    </x-nav-link>
                    <x-nav-link :href="route('quiz.start')" :active="request()->routeIs('quiz.start')">
                        {{ __('Quiz do ECA') }}
                    </x-nav-link>
...
<div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- SEU LINK "ECA" --}}
            <x-responsive-nav-link :href="route('eca.show')" :active="request()->routeIs('eca.show')">
                {{ __('ECA') }}
            </x-responsive-nav-link>
